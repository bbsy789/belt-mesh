                                     ...
                                     index_t p_beginIndex)
{
    ...
    //两层循环生成螺纹网格
    for (index_t i = 0; i <= p_screwThreadMesh.axisNumber; ++i)
    {
        for (index_t j = 0; j < p_screwThreadMesh.rNumber; ++j)
        {
                               ...
                               index_t p_beginIndex)
{
    ...
    index_t axisNumber = p_screwThreadMesh.axisNumber;
    index_t rNumber = p_screwThreadMesh.rNumber;
